...
<body>
	...
	<form name="admin" action="Controller" method="post">
		...
		<nav id="links">
			<ul>
				...
				<li><a href="admin_update.jsp" title="Update"> <i
						class="fa fa-pencil-square  fa-4x"></i>
				</a></li>
		...
		<div class="container text-center">
			...
			%>
			<span style="color: green"> <b> Update Successful!! </b>
			</span>
			<%
				}
					if (db_update_result.equals("failure")) {
			%>
			<span style="color: red"> <b> Update Failure! Please try
					again! </b>
			</span>
			<%
				}
			...
			%>
			<br /> <br /> <select name="admin_classifer_choice">
				<option value=""></option>
				<option value="Books">Books</option>
				<option value="Electronics">Electronics</option>
				<option value="Icecream">Ice Cream</option>
			</select> <input type="submit" value=" > " name="admin_catagory" /> <br /> <br />
			...
			<label for="Name">ID:</label> <input type="text" class="form-control"
				name="admin_product_id" required /> <label for="Name">Name:</label>
			<input type="text" class="form-control" name="admin_product_name"
				required /> <label for="Author">Author/Store</label> <input
				type="text" class="form-control"
				name="admin_product_author_store_name" required /> <label
				for="Description">Description:</label> <input type="text"
				class="form-control" name="admin_product_description" required /> <label
				for="Price">Price</label> <input type="text" class="form-control"
				name="admin_product_price" required />
